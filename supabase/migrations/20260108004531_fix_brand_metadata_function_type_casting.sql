/*
  # Fix Brand Metadata Function Type Casting

  1. Changes
    - Drop and recreate function with proper type casting for available_months
    - Cast integer month_count to bigint to match return type
*/
