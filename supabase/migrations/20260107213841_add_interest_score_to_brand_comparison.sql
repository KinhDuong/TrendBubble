/*
  # Add Interest Score to Brand Comparison Stats

  ## Overview
  Updates the calculate_brand_comparison_stats function to include average interest score
  for each brand in the comparison.

  ## Changes
  - Adds "avgInterestScore" field to calculate average interest_score for all keywords
  - Only includes non-null interest scores in the average

  ## Usage
  The avgInterestScore provides a brand-level aggregate of keyword interest scores,
  helping users understand overall awareness/cultural buzz potential across all keywords.
*/
